...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen pt-32 flex items-center justify-center bg-midnight-950 px-4 relative overflow-hidden">
        ...
        <div className="absolute top-0 right-1/4 w-[500px] h-[500px] bg-gold-500/5 rounded-full blur-[100px] pointer-events-none" />
      ...
      >
        <div className="text-center mb-12">
            <h2 className="text-4xl font-serif text-white mb-2">Join Lumière</h2>
            <p className="text-white/40 text-sm tracking-widest uppercase">Begin your legacy</p>
        </div>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
                <div className="space-y-2">
                    <label className="text-xs uppercase tracking-widest text-white/40 block">Full Name</label>
                    <input 
                      type="text" 
                      value={name} 
        ...
        <div className="mt-12 text-center">
            <p className="text-white/40 text-xs uppercase tracking-widest mb-4">Already a member?</p>
            <Link to="/login" className="text-white border-b border-white/30 pb-1 hover:text-gold-400 hover:border-gold-400 transition-all text-sm">
                Sign In
            </Link>
        </div>
      </motion.div>
